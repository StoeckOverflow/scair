...
// LOWER-NEXT:   %[[M:[0-9]+]] = "d_tensor.size.param"() : () -> !d_tensor.size
// LOWER-NEXT:   %[[N:[0-9]+]] = "d_tensor.size.param"() : () -> !d_tensor.size
// LOWER-NEXT:   %[[Q:[0-9]+]] = "d_tensor.size.param"() : () -> !d_tensor.size
// LOWER-NEXT:   %[[A:[0-9]+]] = "test.a"() : () -> !d_tensor.tensor<[%[[M]], %[[N]]], f32>
// LOWER-NEXT:   %[[MN:[0-9]+]] = "d_tensor.size.mul"(%[[M]], %[[N]]) : (!d_tensor.size, !d_tensor.size) -> !d_tensor.size
...
// LOWER-LABEL: builtin.module {
// LOWER-NEXT:   %[[MT:[0-9]+]] = "d_tensor.size.param"() : () -> !d_tensor.size
// LOWER-NEXT:   %[[TM:[0-9]+]] = "d_tensor.size.param"() : () -> !d_tensor.size
// LOWER-NEXT:   %[[N:[0-9]+]] = "d_tensor.size.param"() : () -> !d_tensor.size
// LOWER-NEXT:   %[[Q:[0-9]+]] = "d_tensor.size.param"() : () -> !d_tensor.size
// LOWER-NEXT:   %[[B:[0-9]+]] = "test.b"() : () -> !d_tensor.tensor<[%[[MT]], %[[TM]], %[[N]]], f32>
// LOWER-NEXT:   %[[M:[0-9]+]] = "d_tensor.size.mul"(%[[MT]], %[[TM]]) : (!d_tensor.size, !d_tensor.size) -> !d_tensor.size
...
// LOWER-NEXT:   %[[TM:[0-9]+]] = "d_tensor.size.param"() : () -> !d_tensor.size
// LOWER-NEXT:   %[[A:[0-9]+]] = "test.a"() : () -> !d_tensor.tensor<[%[[M]]], f32>
// LOWER-NEXT:   %[[SPLIT:[0-9]+]] = "d_tensor.split_dim"(%[[A]], %[[MT]], %[[TM]]) <{dim = 0 : i32}> : (!d_tensor.tensor<[%[[M]]], f32>, !d_tensor.size, !d_tensor.size) -> !d_tensor.tensor<[%[[MT]], %[[TM]]], f32>
