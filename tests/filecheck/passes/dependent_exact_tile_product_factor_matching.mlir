...
// RUN: scair-opt %s --allow-unregistered-dialect -p canonicalize-dtensor-nat-products,dependent-product-loop-exact-tile | filecheck %s --check-prefix=EAGER --implicit-check-not=arith.minsi --implicit-check-not=affine.min --implicit-check-not=d_affine.min

builtin.module {
  func.func @commuted_static_product(%out: memref<?xf32>) {
    %k1_nat = "dtensor.nat.const"() <{value = 8 : i32}> : () -> !dtensor.nat
    %k0_nat = "dtensor.nat.const"() <{value = 4 : i32}> : () -> !dtensor.nat
    %k_nat = "dtensor.nat.mul"(%k1_nat, %k0_nat) : (!dtensor.nat, !dtensor.nat) -> !dtensor.nat
  ...
  func.func @nested_static_product(%out: memref<?xf32>) {
    %k0_nat = "dtensor.nat.const"() <{value = 3 : i32}> : () -> !dtensor.nat
    %k1_nat = "dtensor.nat.const"() <{value = 5 : i32}> : () -> !dtensor.nat
    %k2_nat = "dtensor.nat.const"() <{value = 7 : i32}> : () -> !dtensor.nat
    %k01_nat = "dtensor.nat.mul"(%k0_nat, %k1_nat) : (!dtensor.nat, !dtensor.nat) -> !dtensor.nat
    %k_nat = "dtensor.nat.mul"(%k01_nat, %k2_nat) : (!dtensor.nat, !dtensor.nat) -> !dtensor.nat
    %ub = "dtensor.shape.to_index"(%k_nat) : (!dtensor.nat) -> index
    %c0 = "arith.constant"() <{value = 0 : index}> : () -> index
    %cst = "arith.constant"() <{value = 0.0 : f32}> : () -> f32
...
// LAZY: %[[K8:[0-9]+]] = "dtensor.nat.const"() <{value = 8 : i32}> : () -> !dtensor.nat
// LAZY: %[[K4:[0-9]+]] = "dtensor.nat.const"() <{value = 4 : i32}> : () -> !dtensor.nat
// LAZY: %[[K:[0-9]+]] = "dtensor.nat.mul"(%[[K8]], %[[K4]]) : (!dtensor.nat, !dtensor.nat) -> !dtensor.nat
// LAZY: %[[UB:[0-9]+]] = "dtensor.shape.to_index"(%[[K]]) : (!dtensor.nat) -> index
...
// LAZY: %[[TILE_SIZE:[0-9]+]] = "dtensor.shape.to_index"(%[[K4]]) : (!dtensor.nat) -> index
...
// LAZY: %[[N0:[0-9]+]] = "dtensor.nat.const"() <{value = 3 : i32}> : () -> !dtensor.nat
// LAZY: %[[N1:[0-9]+]] = "dtensor.nat.const"() <{value = 5 : i32}> : () -> !dtensor.nat
// LAZY: %[[N2:[0-9]+]] = "dtensor.nat.const"() <{value = 7 : i32}> : () -> !dtensor.nat
// LAZY: %[[N01:[0-9]+]] = "dtensor.nat.mul"(%[[N0]], %[[N1]]) : (!dtensor.nat, !dtensor.nat) -> !dtensor.nat
// LAZY: %[[NK:[0-9]+]] = "dtensor.nat.mul"(%[[N01]], %[[N2]]) : (!dtensor.nat, !dtensor.nat) -> !dtensor.nat
// LAZY: %[[NUB:[0-9]+]] = "dtensor.shape.to_index"(%[[NK]]) : (!dtensor.nat) -> index
...
// LAZY: %[[NTILE_SIZE:[0-9]+]] = "dtensor.shape.to_index"(%[[N2]]) : (!dtensor.nat) -> index
...
// EAGER: %[[K8:[0-9]+]] = "dtensor.nat.const"() <{value = 8 : i32}> : () -> !dtensor.nat
// EAGER: %[[K4:[0-9]+]] = "dtensor.nat.const"() <{value = 4 : i32}> : () -> !dtensor.nat
// EAGER: %[[K:[0-9]+]] = "dtensor.nat.mul"(%[[K4]], %[[K8]]) : (!dtensor.nat, !dtensor.nat) -> !dtensor.nat
// EAGER: %[[UB:[0-9]+]] = "dtensor.shape.to_index"(%[[K]]) : (!dtensor.nat) -> index
...
// EAGER: %[[TILE_SIZE:[0-9]+]] = "dtensor.shape.to_index"(%[[K8]]) : (!dtensor.nat) -> index
...
// EAGER: %[[N0:[0-9]+]] = "dtensor.nat.const"() <{value = 3 : i32}> : () -> !dtensor.nat
// EAGER: %[[N1:[0-9]+]] = "dtensor.nat.const"() <{value = 5 : i32}> : () -> !dtensor.nat
// EAGER: %[[N2:[0-9]+]] = "dtensor.nat.const"() <{value = 7 : i32}> : () -> !dtensor.nat
// EAGER: %[[N01:[0-9]+]] = "dtensor.nat.mul"(%[[N0]], %[[N1]]) : (!dtensor.nat, !dtensor.nat) -> !dtensor.nat
// EAGER: %[[NK:[0-9]+]] = "dtensor.nat.mul"(%[[N01]], %[[N2]]) : (!dtensor.nat, !dtensor.nat) -> !dtensor.nat
// EAGER: %[[NUB:[0-9]+]] = "dtensor.shape.to_index"(%[[NK]]) : (!dtensor.nat) -> index
...
// EAGER: %[[NTILE_SIZE:[0-9]+]] = "dtensor.shape.to_index"(%[[N2]]) : (!dtensor.nat) -> index
