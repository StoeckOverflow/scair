...
// CHECK-LABEL: func.func @canon
// CHECK: %[[VIEW:.*]] = "test.layout"() : () -> !d_memref.memref<[%{{.*}}], i32, offset: %0, strides: [%1]>
// CHECK: "test.keep"(%[[VIEW]], %2) : (!d_memref.memref<[%{{.*}}], i32, offset: %0, strides: [%1]>, index) -> ()
