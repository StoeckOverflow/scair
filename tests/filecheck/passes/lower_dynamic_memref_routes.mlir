...
// P1-NEXT:    %2 = llvm.mlir.constant 1024 : index : index
// P1-NEXT:    %3 = llvm.mlir.constant 1 : index : index
// P1-NEXT:    %4 = llvm.mlir.constant 0 : index : index
// P1-NEXT:    %5 = llvm.mlir.constant 0.0 : f32 : f32
// P1-NEXT:    %6 = llvm.mlir.constant 256 : index : index
// P1-NEXT:    %7 = "llvm.mul"(%6, %0) : (index, index) -> index
// P1-NEXT:    %8 = llvm.mlir.zero : !llvm.ptr
// P1-NEXT:    %9 = "llvm.getelementptr"(%8, %7) <{rawConstantIndices = array<i32: -2147483648>, elem_type = f32}> : (!llvm.ptr, index) -> !llvm.ptr
...
// P1-NEXT:    %16 = "llvm.insertvalue"(%7, %15) <{position = array<i32: 3, 0>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>
// P1-NEXT:    %17 = "llvm.insertvalue"(%3, %16) <{position = array<i32: 4, 0>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>
...
// P1-NEXT:    %24 = "llvm.insertvalue"(%6, %23) <{position = array<i32: 3, 0>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>
// P1-NEXT:    %25 = "llvm.insertvalue"(%2, %24) <{position = array<i32: 3, 1>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>
...
// P1-NEXT:    %30 = "llvm.icmp"(%28, %6) <{predicate = "slt"}> : (index, index) -> i1
...
// P1-NEXT:    %36 = "llvm.icmp"(%34, %2) <{predicate = "slt"}> : (index, index) -> i1
...
// P2-NEXT:    %2 = llvm.mlir.constant 1024 : index : index
// P2-NEXT:    %3 = llvm.mlir.constant 1 : index : index
...
// P2-NEXT:    %7 = "llvm.mul"(%6, %0) : (index, index) -> index
// P2-NEXT:    %8 = llvm.mlir.zero : !llvm.ptr
// P2-NEXT:    %9 = "llvm.getelementptr"(%8, %7) <{rawConstantIndices = array<i32: -2147483648>, elem_type = f32}> : (!llvm.ptr, index) -> !llvm.ptr
...
// P2-NEXT:    %16 = "llvm.insertvalue"(%7, %15) <{position = array<i32: 3, 0>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>
// P2-NEXT:    %17 = "llvm.insertvalue"(%3, %16) <{position = array<i32: 4, 0>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>
...
// P2-NEXT:    %24 = "llvm.insertvalue"(%6, %23) <{position = array<i32: 3, 0>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>
// P2-NEXT:    %25 = "llvm.insertvalue"(%2, %24) <{position = array<i32: 3, 1>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>
...
// P2-NEXT:    %30 = "llvm.icmp"(%28, %6) <{predicate = "slt"}> : (index, index) -> i1
...
// P2-NEXT:    %36 = "llvm.icmp"(%34, %2) <{predicate = "slt"}> : (index, index) -> i1
...
// P2-NEXT:    %49 = "llvm.add"(%38, %3) <{overflowFlags = ["nsw", "nuw"]}> : (index, index) -> index
// P2-NEXT:    "llvm.br"(%37, %49, %48)[^bb3] : (index, index, f32) -> ()
// P2-NEXT:  ^bb5(%50: index, %51: f32):
// P2-NEXT:    %52 = "llvm.add"(%50, %3) <{overflowFlags = ["nsw", "nuw"]}> : (index, index) -> index
...
// P3-NEXT:    %2 = llvm.mlir.constant 1024 : index : index
// P3-NEXT:    %3 = llvm.mlir.constant 1 : index : index
...
// P3-NEXT:    %7 = "llvm.mul"(%6, %0) : (index, index) -> index
// P3-NEXT:    %8 = llvm.mlir.zero : !llvm.ptr
// P3-NEXT:    %9 = "llvm.getelementptr"(%8, %7) <{rawConstantIndices = array<i32: -2147483648>, elem_type = f32}> : (!llvm.ptr, index) -> !llvm.ptr
...
// P3-NEXT:    %16 = "llvm.insertvalue"(%7, %15) <{position = array<i32: 3, 0>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>
// P3-NEXT:    %17 = "llvm.insertvalue"(%3, %16) <{position = array<i32: 4, 0>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<1 x index>, !llvm.array<1 x index>)>
...
// P3-NEXT:    %24 = "llvm.insertvalue"(%6, %23) <{position = array<i32: 3, 0>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>
// P3-NEXT:    %25 = "llvm.insertvalue"(%2, %24) <{position = array<i32: 3, 1>}> : (index, !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, index, !llvm.array<2 x index>, !llvm.array<2 x index>)>
...
// P3-NEXT:    %32 = "llvm.icmp"(%28, %6) <{predicate = "slt"}> : (index, index) -> i1
...
// P3-NEXT:    %46 = "llvm.icmp"(%40, %2) <{predicate = "slt"}> : (index, index) -> i1
...
// P3-NEXT:    %59 = "llvm.add"(%48, %3) <{overflowFlags = ["nsw", "nuw"]}> : (index, index) -> index
...
// P3-NEXT:    %64 = "llvm.add"(%60, %3) <{overflowFlags = ["nsw", "nuw"]}> : (index, index) -> index
