...
// GUARDED: dtensor.nat.mul
// GUARDED: %[[FULL_BOUND:[0-9]+]] = "dtensor.shape.to_index"(%{{[0-9]+}}) : (!dtensor.nat) -> index
// GUARDED: %[[TILE_SIZE:[0-9]+]] = "dtensor.shape.to_index"(%{{[0-9]+}}) : (!dtensor.posnat) -> index
...
// SIMPLIFIED: dtensor.nat.mul
// SIMPLIFIED: %[[FULL_BOUND:[0-9]+]] = "dtensor.shape.to_index"(%{{[0-9]+}}) : (!dtensor.nat) -> index
// SIMPLIFIED: %[[TILE_SIZE:[0-9]+]] = "dtensor.shape.to_index"(%{{[0-9]+}}) : (!dtensor.posnat) -> index
