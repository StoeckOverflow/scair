...
builtin.module {
  func.func @non_strict_nonnegative_is_not_positive(%k: !d_tensor.nat) {
...
// CHECK-NOT: d_tensor.nat.refine_positive
// CHECK: "d_tensor.shape.to_index"(%{{[0-9]+}}) : (!d_tensor.nat) -> index
