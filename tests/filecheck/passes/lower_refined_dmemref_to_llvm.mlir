...
// CHECK-NEXT:    %24 = "llvm.insertvalue"(%2, %23) <{position = array<i32: 3, 0>}>
// CHECK-NEXT:    %25 = "llvm.insertvalue"(%3, %24) <{position = array<i32: 3, 1>}>
...
// CHECK-NEXT:    %30 = "llvm.icmp"(%28, %2) <{predicate = "slt"}> : (index, index) -> i1
...
// CHECK-NEXT:    %36 = "llvm.icmp"(%34, %3) <{predicate = "slt"}> : (index, index) -> i1
...
// CHECK-NEXT:    %49 = "llvm.add"(%38, %7) <{overflowFlags = ["nsw", "nuw"]}> : (index, index) -> index
// CHECK-NEXT:    "llvm.br"(%37, %49, %48)[^bb3] : (index, index, f32) -> ()
// CHECK-NEXT: ^bb5(%50: index, %51: f32):
// CHECK-NEXT:    %52 = "llvm.add"(%50, %7) <{overflowFlags = ["nsw", "nuw"]}> : (index, index) -> index
