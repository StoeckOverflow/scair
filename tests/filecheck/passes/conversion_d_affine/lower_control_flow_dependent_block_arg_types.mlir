...
// BASE-SAME: %[[COND:[0-9]+]]: i1, %[[N:[0-9]+]]: !d_tensor.size, %[[A:[0-9]+]]: !d_memref.memref<[%[[N]]], f32>, %[[B:[0-9]+]]: !d_memref.memref<[%[[N]]], f32>
...
// REFINED-SAME: %[[COND:[0-9]+]]: index, %[[N:[0-9]+]]: !d_tensor.size, %[[A:[0-9]+]]: !d_memref.memref<[%[[N]]], f32>, %[[B:[0-9]+]]: !d_memref.memref<[%[[N]]], f32>
