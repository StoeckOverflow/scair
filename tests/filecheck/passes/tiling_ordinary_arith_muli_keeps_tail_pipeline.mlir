// RUN: scair-opt %s --allow-unregistered-dialect -p ordinary-affine-product-loop-tile-with-tail:3,dependent-tail-min-simplify,canonicalize,cse,dce | filecheck %s --implicit-check-not=dtensor.nat.mul --implicit-check-not=d_affine.for
