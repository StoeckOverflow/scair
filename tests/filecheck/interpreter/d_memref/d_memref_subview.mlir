...
// IR: %1 = "dtensor.nat.const"() <{value = 2 : i32}> : () -> !dtensor.nat
...
// IR: d_memref.store %5, %4[%2] : i32, !d_memref.memref<[%0], i32>
// IR: %6 = d_memref.subview %4[%3][%2][%3] : !d_memref.memref<[%0], i32> -> !d_memref.memref<[%1], i32>
