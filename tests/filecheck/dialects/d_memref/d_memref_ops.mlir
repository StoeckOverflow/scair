...
// VERIFY-NEXT:   %0 = "arith.constant"() <{value = 4 : index}> : () -> index
// VERIFY-NEXT:   %1 = "arith.constant"() <{value = 8 : index}> : () -> index
...
builtin.module {
  %m0 = "arith.constant"() <{value = 4 : index}> : () -> index
...
// VERIFY: d_memref.subview: size provenance mismatch at axis 0; expected result dim to match size operand
