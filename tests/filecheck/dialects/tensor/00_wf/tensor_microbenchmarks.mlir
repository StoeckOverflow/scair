...
func.func @ew_add(%m: index, %n: index) {
...
func.func @cast_id(%m: index, %n: index) {
...
// VERIFY:   func.func @ew_add(%0: index, %1: index) {
...
// VERIFY:   }
// VERIFY:   func.func @saxpy(%0: index, %1: f32) {
...
// VERIFY:   }
// VERIFY:   func.func @cast_id(%0: index, %1: index) {
// VERIFY:     %2 = "d_tensor.empty"() : () -> !d_tensor.tensor<[%0, %1], f32>
