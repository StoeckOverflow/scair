...
func.func @saxpy(%n: !d_tensor.nat, %a: f32) {
...
func.func @cast_id(%m: !d_tensor.nat, %n: !d_tensor.nat) {
...
// VERIFY:   func.func @ew_add(%0: !d_tensor.nat, %1: !d_tensor.nat) {
...
// VERIFY:   }
// VERIFY:   func.func @saxpy(%0: !d_tensor.nat, %1: f32) {
...
// VERIFY:   }
// VERIFY:   func.func @cast_id(%0: !d_tensor.nat, %1: !d_tensor.nat) {
// VERIFY:     %2 = "d_tensor.empty"() : () -> !d_tensor.tensor<[%0, %1], f32>
