...
builtin.module {
  ...
  %b = "d_tensor.nat.param"() : () -> !d_tensor.nat
  %c = "d_tensor.nat.param"() : () -> !d_tensor.nat
  %d = "d_tensor.nat.param"() : () -> !d_tensor.nat
  %ab = "d_tensor.nat.param"() : () -> !d_tensor.nat
  %cd = "d_tensor.nat.param"() : () -> !d_tensor.nat
  %src = "test.src"() : () -> !d_tensor.tensor<[%ab, %cd], f32>
  %expanded = "d_tensor.expand_shape"(%src, %a, %b, %c, %d)
    <{reassociation = [[0 : i32, 1 : i32], [2 : i32, 3 : i32]]}>
    : (!d_tensor.tensor<[%ab, %cd], f32>, !d_tensor.nat, !d_tensor.nat, !d_tensor.nat, !d_tensor.nat)
...
builtin.module {
  ...
  %expanded = "d_tensor.expand_shape"(%src, %m, %n)
    <{reassociation = [[0 : i32, 1 : i32]]}>
    : (!d_tensor.tensor<[%flat], f32>, !d_tensor.nat, !d_tensor.nat)
      -> !d_tensor.tensor<[%m, %n], f32>
  "test.keep"(%expanded) : (!d_tensor.tensor<[%m, %n], f32>) -> ()
}

// CHECK: "d_tensor.expand_shape"
// CHECK-SAME: (!d_tensor.tensor<[%2], f32>, !d_tensor.nat, !d_tensor.nat) -> !d_tensor.tensor<[%0, %1], f32>
...
builtin.module {
  %m = "d_tensor.nat.param"() : () -> !d_tensor.nat
  %n = "d_tensor.nat.param"() : () -> !d_tensor.nat
  %out = "d_tensor.nat.param"() : () -> !d_tensor.nat
  %src = "test.src"() : () -> !d_tensor.tensor<[%m, %n], f32>
  %bad = "d_tensor.expand_shape"(%src, %out)
    <{reassociation = [[0 : i32], [1 : i32]]}>
    : (!d_tensor.tensor<[%m, %n], f32>, !d_tensor.nat)
