...
// VERIFY: "func.call_indirect"(%3, %18, %22, %19, %20, %21, %23, %24, %25, %26, %0, %1, %2) : ((!dtensor.nat, !dtensor.nat, !dtensor.nat, index, index, index, index, index, index, !d_memref.memref<[%18, %19], f32, offset: 0, strides: [%20, %21]>, !d_memref.memref<[%19, %22], f32, offset: 0, strides: [%23, %24]>, !d_memref.memref<[%18, %22], f32, offset: 0, strides: [%25, %26]>) -> (), !dtensor.nat, !dtensor.nat, !dtensor.nat, index, index, index, index, index, index, !d_memref.memref<[%18, %19], f32, offset: 0, strides: [%20, %21]>, !d_memref.memref<[%19, %22], f32, offset: 0, strides: [%23, %24]>, !d_memref.memref<[%18, %19], f32, offset: 0, strides: [%25, %26]>) -> ()
