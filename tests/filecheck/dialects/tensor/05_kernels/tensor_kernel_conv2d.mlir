...
// VERIFY: "func.func"() <{sym_name = "conv2d_dynamic", function_type = (!dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%[[N:[0-9]+]], %[[CIN:[0-9]+]], %[[OH:[0-9]+]], %[[OW:[0-9]+]], %[[KH:[0-9]+]], %[[KW:[0-9]+]]], f32>{{,}} !d_memref.memref<[%[[COUT:[0-9]+]], %[[CIN]], %[[KH]], %[[KW]]], f32>{{,}} !d_memref.memref<[%[[N]], %[[COUT]], %[[OH]], %[[OW]]], f32>) -> ()}>
...
// VERIFY: %[[GOOD_KERNEL:[0-9]+]] = "func.constant"() <{value = @conv2d_dynamic}> : () -> (!dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%[[GOOD_N:[0-9]+]], %[[GOOD_CIN:[0-9]+]], %[[GOOD_OH:[0-9]+]], %[[GOOD_OW:[0-9]+]], %[[GOOD_KH:[0-9]+]], %[[GOOD_KW:[0-9]+]]], f32>{{,}} !d_memref.memref<[%[[GOOD_COUT:[0-9]+]], %[[GOOD_CIN]], %[[GOOD_KH]], %[[GOOD_KW]]], f32>{{,}} !d_memref.memref<[%[[GOOD_N]], %[[GOOD_COUT]], %[[GOOD_OH]], %[[GOOD_OW]]], f32>) -> ()
// VERIFY: "func.call_indirect"(%[[GOOD_KERNEL]], %[[GOOD_N]], %[[GOOD_CIN]], %0, %1, %[[GOOD_COUT]], %[[GOOD_KH]], %[[GOOD_KW]], %[[GOOD_OH]], %[[GOOD_OW]], %2, %3, %4) : ((!dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%[[GOOD_N]], %[[GOOD_CIN]], %[[GOOD_OH]], %[[GOOD_OW]], %[[GOOD_KH]], %[[GOOD_KW]]], f32>{{,}} !d_memref.memref<[%[[GOOD_COUT]], %[[GOOD_CIN]], %[[GOOD_KH]], %[[GOOD_KW]]], f32>{{,}} !d_memref.memref<[%[[GOOD_N]], %[[GOOD_COUT]], %[[GOOD_OH]], %[[GOOD_OW]]], f32>) -> (), !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%[[GOOD_N]], %[[GOOD_CIN]], %[[GOOD_OH]], %[[GOOD_OW]], %[[GOOD_KH]], %[[GOOD_KW]]], f32>{{,}} !d_memref.memref<[%[[GOOD_COUT]], %[[GOOD_CIN]], %[[GOOD_KH]], %[[GOOD_KW]]], f32>{{,}} !d_memref.memref<[%[[GOOD_N]], %[[GOOD_COUT]], %[[GOOD_OH]], %[[GOOD_OW]]], f32>) -> ()
// VERIFY: "func.func"() <{sym_name = "call_conv2d_dynamic_bad"
// VERIFY: %[[BAD_KERNEL:[0-9]+]] = "func.constant"() <{value = @conv2d_dynamic}> : () -> (!dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%[[BAD_N:[0-9]+]], %[[BAD_CIN:[0-9]+]], %[[BAD_OH:[0-9]+]], %[[BAD_OW:[0-9]+]], %[[BAD_KH:[0-9]+]], %[[BAD_KW:[0-9]+]]], f32>{{,}} !d_memref.memref<[%[[BAD_COUT:[0-9]+]], %[[BAD_CIN]], %[[BAD_KH]], %[[BAD_KW]]], f32>{{,}} !d_memref.memref<[%[[BAD_N]], %[[BAD_COUT]], %[[BAD_OH]], %[[BAD_OW]]], f32>) -> ()
// VERIFY: "func.call_indirect"(%[[BAD_KERNEL]], %[[BAD_N]], %[[BAD_CIN]], %0, %1, %[[BAD_COUT]], %[[BAD_KH]], %[[BAD_KW]], %[[BAD_OH]], %[[BAD_OW]], %2, %3, %4) : ((!dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%[[BAD_N]], %[[BAD_CIN]], %[[BAD_OH]], %[[BAD_OW]], %[[BAD_KH]], %[[BAD_KW]]], f32>{{,}} !d_memref.memref<[%[[BAD_COUT]], %[[BAD_CIN]], %[[BAD_KH]], %[[BAD_KW]]], f32>{{,}} !d_memref.memref<[%[[BAD_N]], %[[BAD_COUT]], %[[BAD_OH]], %[[BAD_OW]]], f32>) -> (), !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%[[BAD_N]], %[[BAD_CIN]], %[[BAD_OH]], %[[BAD_OW]], %[[BAD_KH]], %[[BAD_KW]]], f32>{{,}} !d_memref.memref<[%[[BAD_COUT]], %[[BAD_CIN]], %[[BAD_KH]], %[[BAD_KW]]], f32>{{,}} !d_memref.memref<[%[[BAD_N]], %[[BAD_CIN]], %[[BAD_OH]], %[[BAD_OW]]], f32>) -> ()
