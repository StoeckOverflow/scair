...
// VERIFY: "func.call_indirect"(%5, %7, %8, %0, %1, %13, %11, %12, %9, %10, %2, %3, %4) : ((!dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%7, %8, %9, %10, %11, %12], f32>, !d_memref.memref<[%13, %8, %11, %12], f32>, !d_memref.memref<[%7, %13, %9, %10], f32>) -> (), !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%7, %8, %9, %10, %11, %12], f32>, !d_memref.memref<[%13, %8, %11, %12], f32>, !d_memref.memref<[%7, %13, %9, %10], f32>) -> ()
...
// VERIFY: "func.call_indirect"(%5, %14, %15, %0, %1, %20, %18, %19, %16, %17, %2, %3, %4) : ((!dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%14, %15, %16, %17, %18, %19], f32>, !d_memref.memref<[%20, %15, %18, %19], f32>, !d_memref.memref<[%14, %20, %16, %17], f32>) -> (), !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !dtensor.nat, !d_memref.memref<[%14, %15, %16, %17, %18, %19], f32>, !d_memref.memref<[%20, %15, %18, %19], f32>, !d_memref.memref<[%14, %15, %16, %17], f32>) -> ()
