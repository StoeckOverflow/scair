...
// - Existing big-chain tests cover representative paths -> add focused MLP-like chain with explicit arith.addi(x,0)/arith.muli(x,1) folding + type-dim rewrite checks.
...
builtin.module {
  ...
  %k_norm = "arith.addi"(%k, %z) : (index, index) -> index
  %m_norm = "arith.muli"(%m, %o) : (index, index) -> index
...
// VERIFY:   %3 = "test.index"() : () -> index
// VERIFY:   %4 = "arith.constant"() <{value = 0 : index}> : () -> index
// VERIFY:   %5 = "arith.constant"() <{value = 1 : index}> : () -> index
// VERIFY:   %6 = "arith.addi"(%1, %4) {{.*}} : (index, index) -> index
// VERIFY:   %7 = "arith.muli"(%0, %5) {{.*}} : (index, index) -> index
...
// CANON:   %3 = "test.index"() : () -> index
// CANON:   %4 = "arith.constant"() <{value = 0 : index}> : () -> index
// CANON:   %5 = "arith.constant"() <{value = 1 : index}> : () -> index
// CANON:   %6 = "arith.addi"(%1, %4) {{.*}} : (index, index) -> index
// CANON:   %7 = "arith.muli"(%0, %5) {{.*}} : (index, index) -> index
// CANON:   %8 = "test.x"() : () -> !d_tensor.tensor<[%7, %6], f32>
// CANON:   %9 = "test.w1"() : () -> !d_tensor.tensor<[%6, %3], f32>
// CANON:   %10 = "test.b1"() : () -> !d_tensor.tensor<[%7, %3], f32>
// CANON:   %11 = "test.w2"() : () -> !d_tensor.tensor<[%3, %2], f32>
// CANON:   %12 = "test.b2"() : () -> !d_tensor.tensor<[%7, %2], f32>
// CANON:   %13 = "d_tensor.matmul"(%8, %9) : (!d_tensor.tensor<[%7, %6], f32>, !d_tensor.tensor<[%6, %3], f32>) -> !d_tensor.tensor<[%7, %3], f32>
// CANON:   %14 = "d_tensor.add"(%13, %10) : (!d_tensor.tensor<[%7, %3], f32>, !d_tensor.tensor<[%7, %3], f32>) -> !d_tensor.tensor<[%7, %3], f32>
// CANON:   %15 = "d_tensor.mul"(%14, %14) : (!d_tensor.tensor<[%7, %3], f32>, !d_tensor.tensor<[%7, %3], f32>) -> !d_tensor.tensor<[%7, %3], f32>
// CANON:   %16 = "d_tensor.matmul"(%15, %11) : (!d_tensor.tensor<[%7, %3], f32>, !d_tensor.tensor<[%3, %2], f32>) -> !d_tensor.tensor<[%7, %2], f32>
// CANON:   %17 = "d_tensor.add"(%16, %12) : (!d_tensor.tensor<[%7, %2], f32>, !d_tensor.tensor<[%7, %2], f32>) -> !d_tensor.tensor<[%7, %2], f32>
// CANON:   %18 = "d_tensor.mul"(%17, %17) : (!d_tensor.tensor<[%7, %2], f32>, !d_tensor.tensor<[%7, %2], f32>) -> !d_tensor.tensor<[%7, %2], f32>
// CANON:   "test.keep_big_like"(%18) : (!d_tensor.tensor<[%7, %2], f32>) -> ()
// CANON: }

// PIPE: builtin.module {
// PIPE:   %0 = "test.index"() : () -> index
// PIPE:   %1 = "test.index"() : () -> index
// PIPE:   %2 = "test.index"() : () -> index
// PIPE:   %3 = "test.index"() : () -> index
...
// CSE:   %2 = "test.index"() : () -> index
// CSE:   %3 = "test.index"() : () -> index
// CSE:   %4 = "arith.constant"() <{value = 0 : index}> : () -> index
// CSE:   %5 = "arith.constant"() <{value = 1 : index}> : () -> index
// CSE:   %6 = "arith.addi"(%1, %4) {{.*}} : (index, index) -> index
// CSE:   %7 = "arith.muli"(%0, %5) {{.*}} : (index, index) -> index
...
// DCE:   %2 = "test.index"() : () -> index
// DCE:   %3 = "test.index"() : () -> index
// DCE:   %4 = "arith.constant"() <{value = 0 : index}> : () -> index
// DCE:   %5 = "arith.constant"() <{value = 1 : index}> : () -> index
// DCE:   %6 = "arith.addi"(%1, %4) {{.*}} : (index, index) -> index
// DCE:   %7 = "arith.muli"(%0, %5) {{.*}} : (index, index) -> index
