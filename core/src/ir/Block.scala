...
object Block:
  ...
  def fromArguments(
    ...
    operations match
      case operation: Operation => Block.applyArgs(arguments, ListType(operation))
      case operations: Iterable[?] =>
        Block.applyArgs(arguments, operations.asInstanceOf[Iterable[Operation]])
  ...
  def fromArguments(
    ...
    fromArguments(arguments, operationsExpr(arguments))
