builtin.module {
  func.func @conv2d_reduction_dim_tiling(
    %n_nat : !dtensor.nat, %cin0_nat : !dtensor.nat, %cin1_nat : !dtensor.posnat,
    %h_nat : !dtensor.nat, %w_nat : !dtensor.nat, %cout_nat : !dtensor.nat,
    %kh_nat : !dtensor.posnat, %kw_nat : !dtensor.posnat,
    %oh_nat : !dtensor.nat, %ow_nat : !dtensor.nat,
