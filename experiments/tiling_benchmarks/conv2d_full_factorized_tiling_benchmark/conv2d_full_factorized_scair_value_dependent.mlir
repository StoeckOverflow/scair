builtin.module {
  func.func @conv2d_full_factorized_tiling(
    %n0_size : !d_tensor.size, %n1_size : !d_tensor.pos_size,
    %cin0_size : !d_tensor.size, %cin1_size : !d_tensor.pos_size,
    %h_size : !d_tensor.size, %w_size : !d_tensor.size,
    %cout0_size : !d_tensor.size, %cout1_size : !d_tensor.pos_size,
    %kh_size : !d_tensor.pos_size, %kw_size : !d_tensor.pos_size,
    %oh0_size : !d_tensor.size, %oh1_size : !d_tensor.pos_size,
    %ow0_size : !d_tensor.size, %ow1_size : !d_tensor.pos_size,
    ...
    %cout_size = "d_tensor.size.mul"(%cout0_size, %cout1_size) : (!d_tensor.size, !d_tensor.pos_size) -> !d_tensor.size
    %oh_size = "d_tensor.size.mul"(%oh0_size, %oh1_size) : (!d_tensor.size, !d_tensor.pos_size) -> !d_tensor.size
    %ow_size = "d_tensor.size.mul"(%ow0_size, %ow1_size) : (!d_tensor.size, !d_tensor.pos_size) -> !d_tensor.size
    ...
    %X = d_memref.reinterpret_cast %Xflat
      : !d_memref.memref<[], f32>
        to !d_memref.memref<[%n_size, %cin_size, %oh_size, %ow_size, %kh_size, %kw_size], f32,
             offset: 0, strides: [%chw, %hw, %w_size, %c1, %w_size, %c1]>
    %K = d_memref.reinterpret_cast %Kflat
      : !d_memref.memref<[], f32>
        to !d_memref.memref<[%cout_size, %cin_size, %kh_size, %kw_size], f32,
             offset: 0, strides: [%cin_khkw_size, %khkw_size, %kw_size, %c1]>
    %Y = d_memref.reinterpret_cast %Yflat
      : !d_memref.memref<[], f32>
        to !d_memref.memref<[%n_size, %cout_size, %oh_size, %ow_size], f32,
             offset: 0, strides: [%cout_ohow, %ohow, %ow_size, %c1]>
