...
| `matmul_kernel_scair_value_dependent.mlir`        | `value_dependent`                              | `dependent-product-loop-exact-tile`, `dependent-product-loop-factorization`     | Exact diagnostic route for the product-structured `K` loop.                                                                        |
