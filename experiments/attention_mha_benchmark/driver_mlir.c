...
int main(int argc, char **argv) {
  ...
  MemRef1D_f32 Qref = make1D(Q, kQKVElements);
  MemRef1D_f32 Kref = make1D(K, kQKVElements);
  MemRef1D_f32 Vref = make1D(V, kQKVElements);
  MemRef1D_f32 scoreRef = make1D(score, kScoreElements);
  MemRef1D_f32 probRef = make1D(prob, kScoreElements);
  MemRef1D_f32 tmpOutRef = make1D(tmp_out, kOutputElements);
  MemRef1D_f32 outRef = make1D(out, kOutputElements);
