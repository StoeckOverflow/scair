...
%4 = llvm.load %2 : !llvm.ptr -> !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<1 x i64>, !llvm.array<1 x i64>)>
%5 = llvm.load %3 : !llvm.ptr -> !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<1 x i64>, !llvm.array<1 x i64>)>
%6 = "llvm.mlir.constant"() <{value = 256}> : () -> i64
%7 = "llvm.mlir.constant"() <{value = 1024}> : () -> i64
%8 = "llvm.mlir.constant"() <{value = 0}> : () -> i64
%9 = "llvm.mlir.constant"() <{value = 0.0 : f32}> : () -> f32
%10 = "llvm.mlir.constant"() <{value = 1.0 : f32}> : () -> f32
%11 = llvm.extractvalue %4[0] : !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<1 x i64>, !llvm.array<1 x i64>)>
%12 = llvm.extractvalue %4[1] : !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<1 x i64>, !llvm.array<1 x i64>)>
...
%17 = llvm.insertvalue %6, %16[3, 0] : !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<2 x i64>, !llvm.array<2 x i64>)>
%18 = llvm.insertvalue %7, %17[3, 1] : !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<2 x i64>, !llvm.array<2 x i64>)>
%19 = llvm.insertvalue %0, %18[4, 0] : !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<2 x i64>, !llvm.array<2 x i64>)>
%20 = llvm.insertvalue %1, %19[4, 1] : !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<2 x i64>, !llvm.array<2 x i64>)>
"llvm.br"(%8)[^bb0] : (i64) -> ()
  ^bb0(%21: i64):
    %22 = "llvm.icmp"(%21, %6) <{predicate = 2}> : (i64, i64) -> i1
  ...
  ^bb3(%23: i64):
    %24 = "llvm.icmp"(%23, %7) <{predicate = 2}> : (i64, i64) -> i1
  ...
  ^bb8:
    %55 = llvm.extractvalue %5[1] : !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<1 x i64>, !llvm.array<1 x i64>)>
    %56 = llvm.extractvalue %5[4, 0] : !llvm.struct<(!llvm.ptr, !llvm.ptr, i64, !llvm.array<1 x i64>, !llvm.array<1 x i64>)>
