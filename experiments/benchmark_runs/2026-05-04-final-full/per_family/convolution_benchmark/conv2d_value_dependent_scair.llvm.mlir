...
"llvm.br"(%13)[^bb0] : (i64) -> ()
  ^bb0(%21: i64):
    %22 = "llvm.icmp"(%21, %0) <{predicate = 2}> : (i64, i64) -> i1
  ...
  ^bb2:
    "llvm.return"() : () -> ()
  ^bb3(%23: i64):
    %24 = "llvm.icmp"(%23, %4) <{predicate = 2}> : (i64, i64) -> i1
  ...
  ^bb5:
    ...
    "llvm.br"(%25)[^bb0] : (i64) -> ()
  ^bb6(%26: i64):
    %27 = "llvm.icmp"(%26, %7) <{predicate = 2}> : (i64, i64) -> i1
  ...
  ^bb8:
    ...
    "llvm.br"(%28)[^bb3] : (i64) -> ()
  ^bb9(%29: i64):
    %30 = "llvm.icmp"(%29, %8) <{predicate = 2}> : (i64, i64) -> i1
  ...
  ^bb11:
    ...
    "llvm.br"(%31)[^bb6] : (i64) -> ()
  ^bb12(%32: i64, %33: f32):
    %34 = "llvm.icmp"(%32, %1) <{predicate = 2}> : (i64, i64) -> i1
  ...
  ^bb15(%35: i64, %36: i64, %37: f32):
    %38 = "llvm.icmp"(%36, %5) <{predicate = 2}> : (i64, i64) -> i1
  ...
  ^bb14:
    ...
    "llvm.br"(%47)[^bb9] : (i64) -> ()
  ^bb18(%48: i64, %49: f32):
    %50 = "llvm.icmp"(%48, %6) <{predicate = 2}> : (i64, i64) -> i1
