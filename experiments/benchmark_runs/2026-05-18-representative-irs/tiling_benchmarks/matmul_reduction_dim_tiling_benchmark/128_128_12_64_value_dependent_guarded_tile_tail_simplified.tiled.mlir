    ...
    d_affine.for %17 = #map(%8) to #map(%11) step 1 : index {
      d_affine.for %18 = #map(%8) to #map(%12) step 1 : index {
        ...
        %20 = d_affine.for %21 = #map(%8) to #map(%13) step %19 : index iter_args(%22 = %10 : f32) {
          ...
          %24 = d_affine.for %25 = #map(%21) to #map(%23) step 1 : i32 iter_args(%26 = %22 : f32) {
            %27 = d_memref.load %14[%17, %25] : !d_memref.memref<[%0, %7], f32, offset: 0, strides: [%13, %9]> -> f32
            %28 = d_memref.load %15[%25, %18] : !d_memref.memref<[%7, %1], f32, offset: 0, strides: [%12, %9]> -> f32
            %29 = "arith.mulf"(%27, %28) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
            %30 = "arith.addf"(%26, %29) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
            d_affine.yield %30 : (f32)
          }
          d_affine.yield %24 : (f32)
        }
