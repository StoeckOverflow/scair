...
module {
  func.func @matmul_reduction_dim_tiling(%arg0: index, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<?xf32>, %arg5: memref<?xf32>, %arg6: memref<?xf32>) attributes {llvm.emit_c_interface} {
    ...
    affine.for %arg7 = 0 to %arg0 step 64 {
      affine.for %arg8 = 0 to %arg1 step 64 {
