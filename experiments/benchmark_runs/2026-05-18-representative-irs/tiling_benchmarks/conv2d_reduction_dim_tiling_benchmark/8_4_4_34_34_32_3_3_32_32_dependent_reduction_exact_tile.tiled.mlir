        ...
        d_affine.for %39 = #map(%17) to #map(%26) step 1 : index {
          d_affine.for %40 = #map(%17) to #map(%27) step 1 : index {
            %41 = d_affine.for %42 = #map(%17) to #map(%29) step %25 : index iter_args(%43 = %19 : f32) {
              ...
              %45 = d_affine.for %46 = #map(%42) to #map(%44) step 1 : i32 iter_args(%47 = %43 : f32) {
                %48 = "arith.divui"(%46, %28) : (index, index) -> index
                %49 = "arith.remui"(%46, %28) : (index, index) -> index
                %50 = "arith.divui"(%49, %25) : (index, index) -> index
                %51 = "arith.remui"(%49, %25) : (index, index) -> index
                %52 = d_memref.load %34[%37, %48, %39, %40, %50, %51] : !d_memref.memref<[%0, %13, %8, %9, %6, %7], f32, offset: 0, strides: [%31, %30, %23, %18, %23, %18]> -> f32
                %53 = d_memref.load %35[%38, %48, %50, %51] : !d_memref.memref<[%5, %13, %6, %7], f32, offset: 0, strides: [%29, %28, %25, %18]> -> f32
                %54 = "arith.mulf"(%52, %53) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
                %55 = "arith.addf"(%47, %54) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
                d_affine.yield %55 : (f32)
              }
              d_affine.yield %45 : (f32)
            }
