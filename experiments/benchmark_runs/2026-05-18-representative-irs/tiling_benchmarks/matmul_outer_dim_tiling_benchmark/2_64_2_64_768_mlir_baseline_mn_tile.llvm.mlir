module {
  ...
  ^bb2:  // pred: ^bb1
    llvm.br ^bb3(%19 : i64)
  ^bb3(%56: i64):  // 2 preds: ^bb2, ^bb13
    %57 = llvm.icmp "slt" %56, %23 : i64
    llvm.cond_br %57, ^bb4, ^bb14
  ^bb4:  // pred: ^bb3
    %58 = llvm.add %54, %18 : i64
    %59 = llvm.intr.smin(%58, %22) : (i64, i64) -> i64
    llvm.br ^bb5(%54 : i64)
  ^bb5(%60: i64):  // 2 preds: ^bb4, ^bb12
    %61 = llvm.icmp "slt" %60, %59 : i64
    llvm.cond_br %61, ^bb6, ^bb13
  ^bb6:  // pred: ^bb5
    %62 = llvm.add %56, %18 : i64
  ...
  ^bb10:  // pred: ^bb9
    ...
    %73 = llvm.mul %60, %72 overflow<nsw, nuw> : i64
  ...
  ^bb11:  // pred: ^bb9
    ...
    %96 = llvm.mul %60, %95 overflow<nsw, nuw> : i64
    ...
    llvm.br ^bb7(%101 : i64)
  ^bb12:  // pred: ^bb7
    %102 = llvm.add %60, %20 : i64
    llvm.br ^bb5(%102 : i64)
  ^bb13:  // pred: ^bb5
    %103 = llvm.add %56, %18 : i64
    llvm.br ^bb3(%103 : i64)
  ^bb14:  // pred: ^bb3
