...
%6 = "llvm.mlir.constant"() <{value = 0}> : () -> i64
%7 = "llvm.add"(%2, %6) : (i64, i64) -> i64
%8 = "llvm.add"(%3, %6) : (i64, i64) -> i64
...
"llvm.br"(%10)[^bb0] : (i64) -> ()
  ...
  ^bb5:
    %17 = "llvm.mul"(%13, %7) : (i64, i64) -> i64
    %18 = "llvm.mul"(%15, %8) : (i64, i64) -> i64
    %19 = "llvm.add"(%17, %18) : (i64, i64) -> i64
    %20 = "llvm.getelementptr"(%4, %19) <{rawConstantIndices = array<i32: -2147483648>, elem_type = f32}> : (!llvm.ptr, i64) -> !llvm.ptr
    "llvm.store"(%12, %20) : (f32, !llvm.ptr) -> ()
    %21 = "llvm.add"(%15, %9) : (i64, i64) -> i64
    "llvm.br"(%21)[^bb3] : (i64) -> ()
  ^bb6:
    %22 = "llvm.add"(%13, %9) : (i64, i64) -> i64
    "llvm.br"(%22)[^bb0] : (i64) -> ()
  ^bb4(%23: i64, %24: f32):
    %25 = llvm.icmp "slt" %23, %0 : i64
    "llvm.cond_br"(%25)[^bb7, ^bb8] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb7:
    "llvm.br"(%23, %10, %24)[^bb9] : (i64, i64, f32) -> ()
  ^bb9(%26: i64, %27: i64, %28: f32):
    %29 = llvm.icmp "slt" %27, %1 : i64
    "llvm.cond_br"(%29)[^bb10, ^bb11] <{operandSegmentSizes = array<i32: 1, 0, 0>}> : (i1) -> ()
  ^bb10:
    %30 = "llvm.mul"(%26, %7) : (i64, i64) -> i64
    %31 = "llvm.mul"(%27, %8) : (i64, i64) -> i64
    %32 = "llvm.add"(%30, %31) : (i64, i64) -> i64
    %33 = "llvm.getelementptr"(%4, %32) <{rawConstantIndices = array<i32: -2147483648>, elem_type = f32}> : (!llvm.ptr, i64) -> !llvm.ptr
    %34 = llvm.load %33 : !llvm.ptr -> f32
    %35 = "llvm.fadd"(%28, %34) : (f32, f32) -> f32
    %36 = "llvm.add"(%27, %9) : (i64, i64) -> i64
    "llvm.br"(%26, %36, %35)[^bb9] : (i64, i64, f32) -> ()
  ^bb11:
    %37 = "llvm.add"(%26, %9) : (i64, i64) -> i64
    "llvm.br"(%37, %28)[^bb4] : (i64, f32) -> ()
  ^bb8:
    %38 = "llvm.getelementptr"(%5, %10) <{rawConstantIndices = array<i32: -2147483648>, elem_type = f32}> : (!llvm.ptr, i64) -> !llvm.ptr
