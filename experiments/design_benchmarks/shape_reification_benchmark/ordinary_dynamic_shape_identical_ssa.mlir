module {
  func.func @ordinary_identical_ssa(%arg0: tensor<?x?xf32>) -> index {
    ...
    %b0 = tensor.dim %arg0, %c0 : tensor<?x?xf32>
    %b1 = tensor.dim %arg0, %c1 : tensor<?x?xf32>
    %c0_dim = tensor.dim %arg0, %c0 : tensor<?x?xf32>
    %c1_dim = tensor.dim %arg0, %c1 : tensor<?x?xf32>
    %d0 = tensor.dim %arg0, %c0 : tensor<?x?xf32>
    %d1 = tensor.dim %arg0, %c1 : tensor<?x?xf32>
    %e0 = tensor.dim %arg0, %c0 : tensor<?x?xf32>
    %e1 = tensor.dim %arg0, %c1 : tensor<?x?xf32>
    %f0 = tensor.dim %arg0, %c0 : tensor<?x?xf32>
    %f1 = tensor.dim %arg0, %c1 : tensor<?x?xf32>
