builtin.module {
  func.func @dependent_same_shape_different_ssa(
      %m: !dtensor.nat,
      %n: !dtensor.nat,
      %a: !dtensor.tensor<[%m, %n], f32>,
      %b: !dtensor.tensor<[%m, %n], f32>,
      %c: !dtensor.tensor<[%m, %n], f32>,
      %d: !dtensor.tensor<[%m, %n], f32>,
      %e: !dtensor.tensor<[%m, %n], f32>,
      %f: !dtensor.tensor<[%m, %n], f32>) -> index {
