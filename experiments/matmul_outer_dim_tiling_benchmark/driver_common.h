#ifndef MATMUL_OUTER_DIM_DRIVER_COMMON_H
#define MATMUL_OUTER_DIM_DRIVER_COMMON_H
...
#ifndef BENCH_LABEL
#define BENCH_LABEL "matmul_outer_dim_tiling"
#endif
...
enum {
#ifndef MATMUL_OUTER_DIM_M0
#define MATMUL_OUTER_DIM_M0 2
#endif
#ifndef MATMUL_OUTER_DIM_M1
#define MATMUL_OUTER_DIM_M1 64
#endif
#ifndef MATMUL_OUTER_DIM_N0
#define MATMUL_OUTER_DIM_N0 2
#endif
#ifndef MATMUL_OUTER_DIM_N1
#define MATMUL_OUTER_DIM_N1 64
#endif
#ifndef MATMUL_OUTER_DIM_K
#define MATMUL_OUTER_DIM_K 768
#endif
  kM0 = MATMUL_OUTER_DIM_M0,
  kM1 = MATMUL_OUTER_DIM_M1,
  kN0 = MATMUL_OUTER_DIM_N0,
  kN1 = MATMUL_OUTER_DIM_N1,
  kK = MATMUL_OUTER_DIM_K,
  kM = kM0 * kM1,
  kN = kN0 * kN1,
  kAElements = kM * kK,
  kBElements = kK * kN,
